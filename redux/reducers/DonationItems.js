...
const DonationItemSlice = createSlice({
  name: "donationItems",
  initialState: initialDonationItems,
  reducers: {
    resetCatItem: () => {
      return initialDonationItems;
    },
  },
});

export const { resetCatItem } = DonationItemSlice.actions;
export default DonationItemSlice.reducer;
